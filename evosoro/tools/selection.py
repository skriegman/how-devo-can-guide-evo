...
def pareto_selection(population):
    ...
    # if multiple 'learning' trials then only keep the best result, this also updates num_successful_trials
    if population.learning_trials > 1 and population.gen > 0:
        population.keep_only_one_learning_trial()
